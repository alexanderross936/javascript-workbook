...
function sumEvens(numbers){
  ...
  var array = [];
  array.push(numbers.filter(isEven));
  var nArray = array[0];
  var sum = nArray[0];
  console.log(nArray);
...
function atxFunc(arr){
  var array = [];
  for(var i=0; i < arr.length; i++){
    array.push(Number(arr[i]));
  }

  const is512 = (element, idx) => element + idx === 512;
  return array.findIndex(is512);
}

var atxIdx = atxFunc(strNums);
